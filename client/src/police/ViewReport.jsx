...
export default function ViewReport() {
  ...
  const styleDic = isBrowser ? { fontSize: "18px", color: "red" } : { fontSize: "14px", color: "white" };

  const bottomBar = isBrowser ? "" : " bottom-bar-red"

  const [design, setDesign] = useState("patient_detials");
  return (
    <>
      <Layout heading="Report severity" appBarColor="danger" />
